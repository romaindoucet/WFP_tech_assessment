...
# Setup paths
EXCEL_DATA_FILE_PATH = "../data/Technical Assignment_Data_dev.xlsx"
OUTPUT_DIR = "charts"
...
INVOKE_CLAUDE_FOR_MISSING_DATA = False  # Use existing CSV
...
# Extract product code and expiry date
...
# Load Claude categorizations
df_claude_cat = pd.read_csv("claude_missing_cat.csv")

# Build final stock dataframe
df_stock = (
    df_storage
    ...
    .merge(
        df_product_details
        [["product_code", "product_category", "product_sub_category"]],
...
# ============================================================================
# CHART 2: Adults with HIV - Stock Levels
# ============================================================================
df_stock_adults_HIV = (
    df_stock
...
print("✓ Chart 2: HIV adult stock levels")

# ============================================================================
# CHART 3: Adults with HIV - Expiry Distribution
# ============================================================================
...
print("✓ Chart 3: HIV adult expiry distribution")

# ============================================================================
# CHART 4: Malaria Out of Stock Dates
# ============================================================================
# Build stock evolution
...
print(f"\n✓ All charts exported to '{OUTPUT_DIR}/' directory")
